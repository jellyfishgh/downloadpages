...
0),y.push(0);A=!!window.addEventListener;P="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;(function(){var a=navigator.userAgent,g=a.indexOf("Android"),d;C=-1!==a.indexOf("QQBrowser")?200:0;-1!==g&&(d=a.substring(g+7,g+11).replace(" ",""));return d||0})();k=function(a){switch(!0){case ""===a.webkitTransition:return"webkit";case ""===a.MozTransition:return"Moz";case ""===a.msTransition:return"ms";case ""===a.OTransition:return"O";default:return""}}(document.createElement("Chriswang").style);D.prototype={epsilon:.01,sampleCurveX:function(a){return((this.ax*a+this.bx)*a+this.cx)*a},sampleCurveY:function(a){return((this.ay*a+this.by)*a+this.cy)*a},sampleCurveDerivativeX:function(a){return(3*this.ax*a+2*this.bx)*a+this.cx},solveCurveX:function(a,g){var d,b,e,c;e=a;for(b=0;8>b;b++){c=this.sampleCurveX(e)-a;if(Math.abs(c)<g)return e;d=this.sampleCurveDerivativeX(e);if(Math.abs(d)<g)break;e-=c/d}d=0;b=1;e=a;if(e<d)return d;if(e>b)return b;for(;d<b;){c=this.sampleCurveX(e);if(Math.abs(c-a)<g)break;a>c?d=e:b=e;e=.5*(b-d)+d}return e},solve:function(a,g){return this.sampleCurveY(this.solveCurveX(a,g))}};I=function(){h=document.documentElement.clientWidth||window.innerWidth;s=document.documentElement.clientHeight||window.innerHeight;E.style.height=s+"px"};l=function(a,g,b,c){L=a;F=g;G=b;T=c};if("string"===typeof f.easing)switch(f.easing){case "ease":l(.25,.1,.25,1);break;case "linear":l(0,0,1,1);break;case "ease-in":l(.42,0,1,1);break;case "ease-out":l(0,0,.58,1);break;case "ease-in-out":l(.42,0,.58,1)}else l(f.easing[0],f.easing[1],f.easing[2],f.easing[3]);if(""!==k){for(;Z--;)H[Z][k+"TransitionTimingFunction"]="cubic-bezier("+L+","+F+","+G+","+T+")";w=function(a,b,d,c,e){a=a.style;b="translate("+b+"px,"+d+"px) translateZ(0)";e.scale&&(b+=0===c?" scale("+e.scale[0]+")":" scale("+e.scale[1]+")");e.rotate&&(b+=0===c?" rotate("+e.rotate[0]+"deg)":" rotate("+e.rotate[1]+"deg)");a[k+"TransformOrigin"]="50% 50%";a[k+"Transform"]=b}}else $=new D(L,F,G,T),w=function(a,b,d,c){var e=a.currentStyle,f=a.style,k=parseInt(f.left||e.left,10),p=parseInt(f.top||e.top,10),l=b-k,s=d-p,r=+new Date+c,h=0,q=x.opacity,t;clearInterval(W);W=setInterval(function(){var a;+new Date>r?(a=q?"left:"+b+"px;top:"+d+"px;filter:alpha(opacity="+100*q[1]+");":"left:"+b+"px;top:"+d+"px;",clearInterval(W)):(t=r-new Date,h=t/c,h=$.solve(1-h,D.prototype.epsilon),a="left:"+(k+l*h)+"px;top:"+(p+s*h)+"px;",q&&(a+="filter:alpha(opacity="+~~(100*(q[1]*h-q[0]*(1-h)))+");"));f.cssText=a},13)};aa={transform:function(a,b,d){var f=0,e=""!==k||"none"!==a.translate&&a.translate?C:-50;switch(a.translate){case "Y":f=d>b?s:-s;w(c[d],0,f,0,a);break;case "X":f=d>b?h:-h;w(c[d],f,0,0,a);break;case "XY":f={X:d>b?h:-h,Y:d>b?s:-s};w(c[d],f.X,f.Y,0,a);break;default:w(c[d],0,0,0,a)}setTimeout(function(){w(c[d],0,0,B,a)},e+50)},opacity:function(a,b,d){var f=c[d].style;f.opacity=a[0];setTimeout(function(){f.opacity=a[1]},70)}};ba=A&&P?navigator.userAgent.indexOf("Firefox")?function(a,b){a.addEventListener("click",b,!1)}:function(a,b,c){a.addEventListener("touchstart",b,!1);c&&a.addEventListener("touchmove",function(a){a.preventDefault()},!1)}:function(a,b){a.onclick=b};p=function(a,b,c){var f=a.className,e=[];if(-1!==f.indexOf(b)){e=f.split(" ");for(f=e.length;f--;)e[f]===b&&(" "===c||""===c?e.splice(f,1):e[f]=c);e.length?a.className=e.join(" "):(a.removeAttribute("class"),a.removeAttribute("className"))}};M&&(R=function(a,b){var c=u[b].className;p(u[a],"active"," ");u[b].className=""===c?"active":c+" active"});f.continuous&&(t=function(a,b){var c=v;if(b)if(a>=
